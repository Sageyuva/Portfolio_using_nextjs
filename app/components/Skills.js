...
const Skills = () => {
  ...
  return (
   <center>
    ...
    <SkillCard per="70%" img="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d9/Node.js_logo.svg/885px-Node.js_logo.svg.png"/>
    <SkillCard per="70%" img="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*XP-mZOrIqX7OsFInN2ngRQ.png"/>
    <SkillCard per="70%" img="https://logowik.com/content/uploads/images/mongodb9740.logowik.com.webp"/>
